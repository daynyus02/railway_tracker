...
def past_day_data_no_delays():
    ...
    return [
        {
            'scheduled_arr_time': datetime.time(21, 20),
            'actual_arr_time': datetime.time(21, 20),
            'scheduled_dep_time': datetime.time(21, 21),
            'actual_dep_time': datetime.time(21, 21),
            'cancellation_id': None,
            'reason': None
        ...
        {
            'scheduled_arr_time': datetime.time(22, 20),
            'actual_arr_time': datetime.time(22, 20),
            'scheduled_dep_time': datetime.time(23, 45),
            'actual_dep_time': datetime.time(23, 45),
            'cancellation_id': None,
            'reason': None
...
def past_day_data_long_delays():
    ...
    return [
        {
            'scheduled_arr_time': datetime.time(21, 20),
            'actual_arr_time': datetime.time(21, 29),
            'scheduled_dep_time': datetime.time(21, 21),
            'actual_dep_time': datetime.time(21, 27),
            'cancellation_id': None,
            'reason': None
        },
        {
    ...
    return [
        {
            ...
            'actual_arr_time': datetime.time(21, 18),
            'scheduled_dep_time': datetime.time(21, 21),
            'actual_dep_time': datetime.time(21, 20),
            'cancellation_id': None,
            'reason': None
        },
        {
            'scheduled_arr_time': datetime.time(22, 20),
            'actual_arr_time': datetime.time(22, 22),
            'scheduled_dep_time': datetime.time(23, 45),
            'actual_dep_time': datetime.time(23, 48),
            'cancellation_id': None,
            'reason': None
        }
    ]
